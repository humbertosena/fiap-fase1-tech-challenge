...
Este projeto utiliza o **MLflow** para rastreamento de experimentos. O banco de dados de metadados (`mlflow.db`) está centralizado na **raiz do projeto** para garantir a interoperabilidade entre os notebooks e os scripts de treinamento da pasta `src/`.
...
O arquivo `mlflow.db` na raiz do projeto está configurado para ser rastreado via **Git LFS (Large File Storage)**. 
